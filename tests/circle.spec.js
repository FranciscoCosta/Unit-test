...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  ...
  it('Verifca se o circle retorna um objecto',()=>{
    expect(typeof(circle(2))).toBe('object');
  })
  it('Verifca se o circle retornado possui 3 propriedades',()=>{
    expect(Object.values(circle(3)).length).toBe(3);
  });
  it('Verifca se o circle quando não recebe nenhum parâmetro, retorna undefined.',()=>{
